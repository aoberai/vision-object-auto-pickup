...
import com.palyrobotics.frc2020.util.KumquatDriveHelper;
...
public class Drive extends Subsystem {
    ...
    private KumquatDriveHelper mKDH = new KumquatDriveHelper();
    ...
    public void update(Commands commands, RobotState state) {
        ...
        switch (mState) {
            case KUMQUAT_VISION:
                setDriveOutputs(mKDH.visionDrive(commands, mRobotState));
                break;
            case CHEZY:
    ...
    public enum DriveState {
        KUMQUAT_VISION, CHEZY, OFF_BOARD_CONTROLLER, ON_BOARD_CONTROLLER, OPEN_LOOP, NEUTRAL, VISION_ASSIST, CLOSED_VISION_ASSIST
    }
