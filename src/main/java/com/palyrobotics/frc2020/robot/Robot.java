...
import com.palyrobotics.frc2020.util.commands.KumquatCommandReceiver;
...
public class Robot extends TimedRobot {
    ...
    public void teleopInit() {
        ...
        new KumquatCommandReceiver().tryConnect();
    }

    @Override
    public void teleopPeriodic() {
//        System.out.println(Limelight.getInstance().getRegressionDistanceZ());
